...
#write as character because you can't write lists to csv
sample_pivot2 = data.frame(lapply(sample_pivot, as.character), stringsAsFactors=FALSE)


#write to csv
write_csv(sample_pivot2, "data/shapefiles_written/2017_2019_sample.csv")
```
